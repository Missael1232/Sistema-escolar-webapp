...
class AdminsViewEdit(generics.CreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        lista_eventos  = EventosSerializer(eventos, many=True).data
        total_eventos  = len(lista_eventos)
       
        return Response({'admins': total_admins,'maestros': total_maestros,'alumnos': total_alumnos, 'evento': total_eventos},200)
