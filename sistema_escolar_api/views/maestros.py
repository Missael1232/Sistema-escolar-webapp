...
class MaestrosViewEdit(generics.CreateAPIView):
    ...
    """    def get(self, request, *args, **kwargs):
           ...
           # lista_alumnos = AlumnosSerializer(alumnos, many=True).data
    ...
    def put(self, request, *args, **kwargs):
        ...
        maestro.area_investigacio= request.data["area_investigacion"]
        # Actualizamos las materias si se incluyen en la petición
        if "materias_json" in request.data:
            # Convertimos el arreglo a JSON para guardarlo en la base de datos
