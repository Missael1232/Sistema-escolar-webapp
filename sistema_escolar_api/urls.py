...
from sistema_escolar_api.views.eventos import EventosView, EventosViewEdit, lista_eventos
...
urlpatterns = [
    ...
    #Edit Maestro
        ...
        # Crear evento (solo POST)
        path('eventos/', EventosView.as_view()),

        # Obtener/Actualizar/Eliminar un evento por ID (GET? PUT? DELETE)
        path('eventos-edit/', EventosViewEdit.as_view()),

        # Listar eventos filtrados por rol
        path('lista-eventos/', lista_eventos),
